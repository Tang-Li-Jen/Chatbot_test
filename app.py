...
def verify():
    ...
    return "Go Go Power Ranger V5", 200
    ...
    data = json.dumps({
        ...
        "message":{
            "attachment":{
                "type":"image",
                "payload":{
                    "url":"http://ansi.loli.tw/ansiarts/4846.png"
                }
            }
        }
    })
    i = requests.post("https://graph.facebook.com/v2.6/me/messages", params=params, headers=headers, data=data)
